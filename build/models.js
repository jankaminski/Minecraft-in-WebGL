...
import { VertexAttribute, Mesh, Model } from "./model.js";
...
const PARTICLE_MESH = new Mesh(particleVertices, particleIndices, new VertexAttribute(0, 3, 3, 0));
const TEXTURED_PARTICLE_MESH = new Mesh(texturedParticleVertices, particleIndices, new VertexAttribute(0, 3, 5, 0), new VertexAttribute(1, 2, 5, 3));
...
export { CREEPER_MODEL, LEAF_MODEL, ANIMATED_PARTICLE_MODEL, BLOCK_BREAK_PARTICLE_MODEL, particleIndices };
