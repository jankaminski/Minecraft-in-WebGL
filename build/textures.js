...
class BlockTextureAtlas extends TextureAtlas {
    constructor() {
        super(gl.CLAMP_TO_EDGE, gl.NEAREST, BLOCK_PIXELS, BLOCK_PIXELS, BLOCK_TEX_ATLAS_COLUMNS, BLOCK_TEX_ATLAS_ROWS);
    }
...
class AnimatedParticleTextureAtlas extends TextureAtlas {
    constructor() {
        super(gl.CLAMP_TO_EDGE, gl.NEAREST, PARTICLE_ANIMATION_MAX_SIZE.x, PARTICLE_ANIMATION_MAX_SIZE.y, PARTICLE_TEX_ATLAS_COLUMNS, PARTICLE_TEX_ATLAS_ROWS);
    }
...
const BLOCK_TEXTURE_ATLAS = new BlockTextureAtlas()
    .addBlock(Block.OAK_LOG, oakLogTexImage, oakLogTexImage, oakLogTopTexImage, oakLogTopTexImage, oakLogTexImage, oakLogTexImage)
    .addBlock(Block.COBBLESTONE, cobbleTexImage)
    .addBlock(Block.MOSSY_COBBLE, mossyCobbleTexImage)
    .addBlock(Block.OAK_PLANKS, oakPlanksTexImage)
    .addBlock(Block.DIRT, dirtTexImage)
    .addBlock(Block.GRASS, grassSideTexImage, grassSideTexImage, grassTopTexImage, dirtTexImage, grassSideTexImage, grassSideTexImage)
    .addBlock(Block.OAK_LEAVES, oakLeavesTexImage);
const ANIMATED_PARTICLE_TEXTURE_ATLAS = new AnimatedParticleTextureAtlas()
    .addParticle(ParticleAnimation.EXPLOSION, oakLeavesTexImage, oakLogTopTexImage, oakLogTexImage, oakPlanksTexImage);
...
export { BLOCK_TEX_ATLAS_ROWS, BLOCK_TEX_ATLAS_COLUMNS, BLOCK_PIXELS, BLOCK_TEXTURE_ATLAS, CREEPER_TEXTURE, particleTexture, PARTICLE_TEX_ATLAS_ROWS, PARTICLE_TEX_ATLAS_COLUMNS, ANIMATED_PARTICLE_TEXTURE_ATLAS };
