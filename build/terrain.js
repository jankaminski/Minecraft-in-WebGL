...
import { OAK_TREE } from './structure.js';
...
class Generator {
    ...
    evalHeight(chunkIndex, x, z) {
        return noiseSimplex2((chunkIndex.x * CHUNK_WIDTH_IN_BLOCKS + x) * this.hillWidth, (chunkIndex.z * CHUNK_WIDTH_IN_BLOCKS + z) * this.hillWidth) * this.hillHeight;
    }
}
